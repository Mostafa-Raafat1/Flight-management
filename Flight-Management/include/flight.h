...
public:
	...
	void create_seating_p();
	void create_passengers_n();
    ...
    void set_departure_time(string de){departure_time_tz = de;}
    void set_seating_capacit(int sc){seating_capacity = sc;}
